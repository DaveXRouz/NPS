...
export function Modal({
  ...
  return (
    ...
    >
      <div
        ref={dialogRef}
        className={`bg-nps-bg-card border border-nps-oracle-border rounded-lg p-4 sm:p-6 w-full ${maxWidth} max-h-[90vh] overflow-y-auto shrink-0 animate-nps-fade-in`}
